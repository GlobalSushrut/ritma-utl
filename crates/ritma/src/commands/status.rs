...
pub async fn run() -> Result<()> {
    ...
    println!(
        "  {} common_models    - Canonical data structures",
        "✓".bright_green()
    );
    println!(
        "  {} index_db         - SQLite persistence",
        "✓".bright_green()
    );
    println!("  {} bar_powers       - 7 power traits", "✓".bright_green());
    println!(
        "  {} bar_pipeline     - Event processing",
        "✓".bright_green()
    );
    println!(
    ...
    println!(
        "  {} cyber_funnel     - 7-stage pipeline",
        "✓".bright_green()
    );
    println!(
        "  {} intent_power     - Drift detection",
        "✓".bright_green()
    );
    println!(
        "  {} proof_standards  - ZK-ready proofs",
        "✓".bright_green()
    );
    println!(
        "  {} middleware_adapters - HTTP/OTEL/Gateway",
        "✓".bright_green()
    );
    println!(
        "  {} bar_config       - Layered configuration",
        "✓".bright_green()
    );
    println!();
    ...
    println!(
        "  {} Run demo: {}",
        "→".bright_white(),
        "ritma demo".bright_white().bold()
    );
    println!(
        "  {} Initialize: {}",
        "→".bright_white(),
        "ritma init ns://acme/prod/api/svc".bright_white().bold()
    );
    println!();
