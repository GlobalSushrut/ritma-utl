use crate::connectors::{
    AwsConnector, Connector, ConnectorConfig, ConnectorKind, GcpConnector, KubernetesConnector,
    NoopConnector, StorageConnector,
};
use crate::containers::ParamBundle;
use crate::env::EnvManager;
use crate::rbac::RbacManager;
use crate::{Result, SecurityKit};
...
impl SecurityKitBuilder {
    ...
    pub fn add_noop_connector(mut self, name: impl Into<String>, kind: ConnectorKind) -> Self {
    ...
    pub fn add_kubernetes_connector(mut self, name: impl Into<String>) -> Self {
    ...
    pub fn add_aws_connector(mut self, name: impl Into<String>) -> Self {
    ...
    pub fn add_gcp_connector(mut self, name: impl Into<String>) -> Self {
    ...
    pub fn add_storage_connector(mut self, name: impl Into<String>) -> Self {
